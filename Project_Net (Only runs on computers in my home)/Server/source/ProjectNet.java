...
public class ProjectNet extends PApplet {
...
public void draw() {
 ...
 //Client Communication
   ...
   s.write(p1.x + " " + p1.y + " " + p1.sX + " " + p1.sY + " " + sM.cS + " " + p1.l + " " + cW + " " + sW + "\n");
   ...
   c = s.available();
     ...
     if (c != null) {
       ...
       data = PApplet.parseInt(split(input, ' '));
...
size(1350, 650); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ProjectNet" };
    if (passedArgs != null) {
